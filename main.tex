...
\newcommand{\authorWithAnd}{ Deepankar Shakya(LECO77BCA02)\\Shwarup Raj Khanal(LECo77BCA05)}



\title{Mitho Delivery : Joy in Food}
\author{Deepankar Shakya(LECO77BCA02)\\Shwarup Raj Khanal(LEC077BCA05)}
\newcommand{\theroll}{}
\date{October 2023}
...
\include{LetterOfApprovalBCA/letter}
...
\include{3SystemDesignAndAnalysis/SystemDesignAndAnalysis}
\include{4ImplementationAndTesting/ImplementationAndTesting}
\include{5Discussion/discussion}
\include{6Appendices/Appendices}
\include{7ConclusionFuture/conclusion}
